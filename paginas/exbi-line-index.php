...
<script type="text/javascript">
 ...
 <?php 
    ...
    $recados = Recados::getRecadosIndex($idDaSessao);
...
?>
                   <div class="comentarios-form">
                    <form  name="commentform" method="post">
                        <img class="foto-user-comment" src="./uploads/user/<?php echo $usessao['img']; ?>" width="50px" height="50px" name="<?php echo $usessao['nome']; ?>"/>
