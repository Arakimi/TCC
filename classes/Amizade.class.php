...
$selAmigos= self::getConn()->prepare('SELECT u.id, u.nome, u.sobrenome, u.img FROM usuario u INNER JOIN amizade a ON (((u.id=a.de) AND (a.para=?)) OR ((u.id=a.para) AND (a.de=?))) AND a.status=1');
